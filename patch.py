...
dec2code = [
    0x00, 0x00, 0x81, 0x90, 0x1E, 0x00, 0x02, 0x24, 0x15, 0x00, 0x22, 0x14, 0x00, 0x00, 0x00, 0x00,
    0x7E, 0x00, 0x82, 0x24, 0x40, 0x00, 0x83, 0x24, 0x00, 0x00, 0x61, 0x90, 0x00, 0x00, 0x00, 0x00,
    0xC0, 0x28, 0x01, 0x00, 0x60, 0x00, 0xA5, 0x30, 0x40, 0x30, 0x01, 0x00, 0x06, 0x00, 0xC6, 0x30,
    0x25, 0x28, 0xC5, 0x00, 0x42, 0x30, 0x01, 0x00, 0x60, 0x00, 0xC6, 0x30, 0xC2, 0x08, 0x01, 0x00,
    0x06, 0x00, 0x21, 0x30, 0x25, 0x08, 0x26, 0x00, 0x01, 0x00, 0x41, 0xA0, 0x00, 0x00, 0x45, 0xA0,
    0xFE, 0xFF, 0x42, 0x24, 0x2B, 0x08, 0x44, 0x00, 0xEF, 0xFF, 0x20, 0x10, 0xFF, 0xFF, 0x63, 0x24,

    # lw $ra, ($sp)
    # nop
    # jr      $ra
    # addiu   $sp, 4
    0x00, 0x00, 0xBF, 0x8F, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0xE0, 0x03, 0x04, 0x00, 0xBD, 0x27,
]
...
# move    $a0, $s0
codebegin = [
    0xFC, 0xFF, 0xBD, 0x27, 0x00, 0x00, 0xBF, 0xAF, 0x02, 0x22, 0x04, 0x00, 0x01, 0x80, 0x01, 0x3C,
    0x00, 0xA2, 0x21, 0x34,
]
...
def _patch(ini: Ini, mm: mmap.mmap):
    ...
    mm.seek(-16, 1)
    mm.write(bytes(codebegin) + jal_rlcdecode + b'\x21\x20\x81\x00\x25\x20\x00\x02' + bytes(dec2code))
